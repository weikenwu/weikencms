...
<form method="post">
		...
		<tr><td>网站名称：<input type="text" class="text" name="webname" value="{$webname}"/></td></tr>
		<tr><td>常规分页：<input type="text" class="text" name="page_size" value="{$page_size}"/></td></tr>
		<tr><td>文章分页：<input type="text" class="text" name="article_size" value="{$article_size}"/></td></tr>
		<tr><td>导航个数：<input type="text" class="text" name="nav_size" value="{$nav_size}"/></td></tr>
		<tr><td>图片上传目录：<input type="text" class="text" name="updir" value="{$updir}"/></td></tr>
		<tr><td>轮播数：<input type="text" class="text" name="ro_num" value="{$ro_num}"/></td></tr>
